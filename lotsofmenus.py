...
# Create dummy user
User1 = User(name="Samapth Atmuri", email="urwithdreamracer@gmail.com",
             picture='https://cdn0.iconfinder.com/data/icons/avatars-6/500/Avatar_boy_man_people_account_boss_client_beard_male_person_user-512.png')
session.add(User1)
session.commit()
